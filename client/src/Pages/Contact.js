            ...
            <div className='contactForm'>
              <form id='contact-form' onSubmit={handleSubmit(onSubmit)} className="col-12 m-3" noValidate >
                ...
                <div className='row formRow'>
                  ...
                  <br></br>
                  <br></br>
                  <p>We're a close-knit bunch in a small company so we can offer a very personal service, You will meet our team, Victor (the managing director), Danny (Finance and Administration),  there to welcome you to the resort.   Meet the team ......</p>
